...
<tr  align="left">
    ...
    <th width="150"  scope="col"><a href="sig.php"><img src="image/myaccount.png" width="155" height="42" border="0" /></a></th>
...
while($fetched = mysqli_fetch_array($r1))
{
    ...
    echo "<td><a href=details.php?pid=".$fetched[1].">"."<img src=mobile/" . $fetched['image'] . " width=170px height=200px border=0 ></a>" ."<br />"."<center>" .$fetched[2]."<center>"."<br /><a href=details.php?pid=".$fetched[1]."><center>View Details</center></a></td>\n";
    $cols++;
    if($cols == $display)
    {
        echo "</tr>\n";
