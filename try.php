...
<table width="1200"  align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td height="30" colspan="10" align="right" valign="middle"> <span class="style22">24x7 Customer service: +8615502679107</span></td>
  </tr>
  <tr>
    <td height="30" colspan="10" align="right" valign="middle">      
  ...
  <tr>
    <td height="300" colspan="7" align="center" valign="top"><img src="image/bannerforsite.jpg" width="1200" height="300" /></td>
  </tr>
 ...
 <tr  align="left" bordercolor="#F30000">
    ...
    <th height="27" colspan="7" scope="col"><table width="100%" align="center" cellpadding="0" cellspacing="0">
      <tr>
        ...
        <td width="100%" rowspan="17" valign="top" scope="col"><a href="mobiles.php" ><img src="image/preBookNow.jpg" alt="e"  name="roll" width="99%" height="100%"  border="0" id="roll"/></a>
        ...
        <th align="right" width="30%" rowspan="20" valign="top" scope="col" ><form id="form1" name="form1" method="post" action=""><br>
          ...
          <form id="form1" name="form1" method="post" action="" >
              <table align="right" width="100%" height="104" border="0">
                <tr>
                  <td width="36%"><div align="right"><span class="style11">User ID:  </span></div></td>
                  <td width="64%"><label>
                ...
                <tr>
                  <td colspan="2"><label>
                    <input align="bottom" type="checkbox" name="remember" id="remember" />
            ...
            <table width="100%" height="75" border="0">
                ...
                <tr align="right">
                  <td align="right"> <form id="form2" name="form2" method="get" action="http://cn.bing.com">
	   
	                <h2><span class="style23">Baidu Search</span><br />
	                  <br />
	                  <input type="text" name="q" id="q" />
	                  <br />
	                  <br />
	                  <input type="submit" name="submit3" id="submit3" value="Baidu Search" />
                                    </h2>
                  </form></td>
                  <td>&nbsp;</td>
                </tr>
