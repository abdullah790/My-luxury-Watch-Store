...
session_start();
	...
	$c=mysqli_connect(host,uname,pass,db) or die(mysqli_connect_error($c));
	 ...
	 else
	 {
	  ...
	  mysqli_query($c,$q) or(mysqli_error($c));
...
<table width="902" height="392" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr align="left">
    ...
    <td width="200" height="50"><a href="addsompany.php"><img src="image/addbrand.png" width="200" height="50" border="0" /></a></td>
  ...
  <tr align="left">
    <td height="50" colspan="6"><table width="75%" height="65" border="0" align="center" cellpadding="0" cellspacing="0" >
      <tr>
