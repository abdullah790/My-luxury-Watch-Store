...
print "    <th width=15% scope=col><div align=center class=style11><a href=feedback.php style=color:#D40000;TEXT-DECORATION: NONE><img src=image/cooltext540787500.png  border=0></a></strong></div></th>";
 print" </tr>";*/
  print "  <th width='171' scope='col'><a href='index.php'><img src='image/homenew.png' width='171' height='42' border='0'/></a></th>";
print "  <th width='171' scope='col'><a href='mobiles.php'><img src='image/brands.png' width='171' height='42' border='0'/></a></th>";
print "  <th width='171' scope='col'><a href='showacc.php'><img src='image/accessories.png' width='171' height='42' border='0'/></a></th>";
print "  <th width='171' scope='col'><a href='showbyprice.php'><img src='image/search-by-price.png' width='171' height='42' border='0'/></a></th>";
print "  <th width='171' scope='col'><a href='showbyword.php'><img src='image/keyword.png' width='171' height='42' border='0'/></a></th>";
print "  <th width='120' scope='col'><a href='sig.php'><img src='image/myaccount.png' width='171' height='42' border='0'/></a></th>";
print "  <th width='120' scope='col'><a href='feedback.php'><img src='image/feedback.png' width='171' height='42' border='0'/></a></th>";
 print" </tr>";
  }
  elseif(isset($_SESSION["admin"]))
	{
...
print  "</tr>";*/
   ...
   print" <td width='171' height='38'><a href='adminpanel.php'><img src='image/adminpanel.png' width='171' height='42' border='0' /></a></td>";
   print" <td width='171' height='38'><a href='addcompany.php'><img src='image/addbrand.png' width='171' height='42' border='0' /></a></td>";
  print"  <td width='171' height='38'><a href='addproduct.php'><img src='image/addprod.png' width='171' height='42' border='0' /></a></td>";
 print"   <td width='171' height='38'><a href='adminsignup.php'><img src='image/ned.png' width='171' height='42' border='0' /></a></td>";
  print" <td width='171' height='38'><a href='showfeedback.php'><img src='image/v_feed.png' width='171' height='42' border='0'/></a></td>";
print"    <td width='171' height='38'><a href='showquery.php'><img src='image/v_query.png' alt='1' width='171' height='42' border='0'/></a></td>";
 print"   <th width='171' scope='col'><a href='addresslocation.php'><a href='location.php'><img src='image/addnewcity.png' width='171' height='42' border='0' /></a></a></th>";
print"  </tr>";
...
print "  <th width='171' scope='col'><a href='showbyprice.php'><img src='image/search-by-price.png' width='171' height='42' border='0'/></a></th>";
print "  <th width='171' scope='col'><a href='showbyword.php'><img src='image/keyword.png' width='171' height='42' border='0'/></a></th>";
print "  <th width='171' scope='col'><a href='sig.php'><img src='image/myaccount.png' width='171' height='42' border='0'/></a></th>";
print "  <th width='171' scope='col'><a href='feedback.php'><img src='image/feedback.png' width='171' height='42' border='0'/></a></th>";
 print" </tr>";
  }
  ?>
