...
<table width="1002" height="337" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr  align="left">
    <th width="150" scope="col"><a href="index.php"><img src="image/homenew.png" width="180" height="42" border="0" /></a></th>
    <th width="150" scope="col"><a href="mobiles.php"><img src="image/brands.png" width="180" height="42" border="0" /></a></th>
    <th width="150"  scope="col"><a href="showacc.php"><img src="image/accessories.png" width="180" height="42" border="0" /></a></th>
    <th width="150"  scope="col"><a href="showbyprice.php"><img src="image/search-by-price.png" width="180" height="42" border="0" /></a></th>
    <th width="160" scope="col"><a href="showbyword.php"><img src="image/keyword.png" width="190" height="42" border="0" /></a></th>
    <th width="120"  scope="col"><a href="sig.php"><img src="image/myaccount.png" width="140" height="42" border="0" /></a></th>
    <th width="120"   scope="col"><a href="feedback.php"><img src="image/feedback.png" width="150" height="42" border="0" /></a></th>
  </tr>
  <tr>
    <th height="27" colspan="7" scope="col"><table width="100%" height="65" border="0" align="center" cellpadding="0" cellspacing="0" >
	 ...
	 $q="select * from producttable where product_name like '%$f%'";
	 $r1=mysqli_query($c,$q) or die(mysqli_error($c));
	 if(mysqli_num_rows($r1)==0)
	 {
		print	 "<font color='red' > <h4 align='center'>Watch with this feature Not Available</h$></font>";
	}
	else
	{
	print "<table width=1200px align='center' bgcolor='white'>";
	print "<tr>";
	print "<td bgcolor='gray'>Name of Watch </td>";
