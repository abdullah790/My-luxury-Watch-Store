...
if (isset($_POST["submit"]))
{
  $an=$_POST["cname"];
	 ...
	 $q="select * from addacc where acc_name='$an'";
...
print  "</tr>";*/
print" <td width='172' height='38'><a href='adminpanel.php'><img src='image/adminpanel.png' width='180' height='42' border='0' /></a></td>";
   print" <td width='172' height='38'><a href='addcompany.php'><img src='image/addbrand.png' width='180' height='42' border='0' /></a></td>";
  print"  <td width='172' height='38'><a href='addproduct.php'><img src='image/addprod.png' width='180' height='42' border='0' /></a></td>";
 print"   <td width='172' height='38'><a href='adminsignup.php'><img src='image/ned.png' width='180' height='42' border='0' /></a></td>";
  print" <td width='172' height='38'><a href='showfeedback.php'><img src='image/v_feed.png' width='190' height='42' border='0'/></a></td>";
print"    <td width='172' height='38'><a href='showquery.php'><img src='image/v_query.png' alt='1' width='172' height='42' border='0'/></a></td>";
 print"   <th width='172' scope='col'><a href='addresslocation.php'><a href='location.php'><img src='image/addnewcity.png' width='172' height='42' border='0' /></a></a></th>";
print"  </tr>";
  }
  else
  {
    ...
    <td height="79" colspan="8" align="center" valign="top"><table width="100%" height="212" border="0" align="center" cellpadding="0" cellspacing="0" >
      <tr>
        <td height="212" scope="col" ><p class="style14 style15">&nbsp;</p>
          ...
          <form action="detail11.php" method="get" enctype="multipart/form-data" name="form1" id="form1">
              <table width="42%" border="0">
                <tr>
                  <td width="42%">Company Name</td>
                  <td width="65%"><label>
